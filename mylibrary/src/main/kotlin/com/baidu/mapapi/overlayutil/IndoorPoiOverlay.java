...
public class IndoorPoiOverlay extends OverlayManager {
  ...
  public final List<OverlayOptions> getOverlayOptions() {
    ...
    int markerSize = 0;
    for (int i = 0;
        i < mIndoorPoiResult.getmArrayPoiInfo().size() && markerSize < MAX_POI_SIZE;
        i++) {
   ...
   * 覆写此方法以改变默认点击行为
   *
   * @param i 被点击的poi在 {@link com.baidu.mapapi.search.poi.PoiIndoorResult#getmArrayPoiInfo()} } 中的索引
   * @return
   */
